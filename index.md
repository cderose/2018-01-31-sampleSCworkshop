...
venue: "Yale University"        # brief name of host site without address (e.g., "Euphoric State University")
address: "120 High Street"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
instructor: ["Catherine DeRose"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
